...
function highLow() {
   ...
   arrNumbers.sort((a, b) => a - b);   // sort array of numbers
   let high = arrNumbers[arrNumbers.length - 1];
   let low = arrNumbers[0];
...
function convertAlpha() {
   let userInput = '';
   userInput = prompt('Enter string to alpha convert: ');
